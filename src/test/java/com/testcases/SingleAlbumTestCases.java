...
public class SingleAlbumTestCases {
	...
	public void testSetOfPhotosForAlbumId(YamlTestDataForPostsAPI1 apitestdata) {
	...
	@Test(dataProvider = "common_test_data_provider", dataProviderClass = DataProviderClass.class)
	public void testListOfElementsInParticularAlbumId(YamlTestDataForPostsAPI1 apitestdata) {
